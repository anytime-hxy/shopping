...
<title><%=SpringUtils.getMessage("admin.login.title")%> -
	Welcome to EASY SHOPPING</title>
...
<body>
	...
	<div class="login">
		<form id="loginForm" action="login.jsp" method="post">
			...
			<div class="link">
				...
				| <a href="#"><%=SpringUtils.getMessage("admin.login.bbs")%></a> | <a
					href="#/about.html"><%=SpringUtils.getMessage("admin.login.about")%></a>
	...
	<fieldset>
		...
		<p>
			请检查EASY SHOPPING程序是否已正确安装 [<a href="<%=base%>/install/">点击此处进行安装</a>]
		</p>
		<p>
